...
ggplot(data = age_gst_full,
  ...
  theme(legend.position = "none",
        ...
        plot.margin = margin(10, 10, 5, 10)
          ...
          title = "Age, Gender, and Grand Slams",
          x = NULL,
          y = "Age at Grand Slam Win",
          subtitle = "On all court types, female tennis players win Grand Slams slightly younger \non average than males, but also win more Grand Slams at older ages.",
